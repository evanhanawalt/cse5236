...
public class GameActivity extends AppCompatActivity {
    ...
    protected void startGame() {
        ...
        if (!humanOpponent || host) game = new Game(player1Id, player2Id, bestOfNumber);
    }
    public void throwRock(View view) {
        if (game.getSelection(player1Id) == null) {
    ...
    private void throwSelection () {
        ...
        if ((humanOpponent && host) || !humanOpponent) {
